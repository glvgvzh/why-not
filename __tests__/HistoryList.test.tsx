...
describe('HistoryList', () => {
  test('handles empty state', async () => {
    ...
    const { getByText } = await render(<HistoryList history={history} />)
  ...
  test('status missed in type DailyQuest shows only date and status', async () => {
    ...
    const { getByText, queryByText } = await render(<HistoryList history={history} />)
  ...
  test('shows sorted history array', async () => {
    ...
    const { getAllByText } = await render(<HistoryList history={history} />)
